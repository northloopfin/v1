...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @objc dynamic open var placeholderFont: UIFont = AppFonts.textBoxCalibri16 {
        didSet {
            updatePlaceholder()
        }
    }
    ...
    fileprivate func updatePlaceholder() {
        ...
        let color = isEnabled ? placeholderColor : disabledColor
            ...
            attributedPlaceholder = NSAttributedString(
                string: placeholder,
                attributes: [
                    NSAttributedStringKey.foregroundColor: color, NSAttributedStringKey.font: placeholderFont
                ]
            )
        #else
            attributedPlaceholder = NSAttributedString(
                string: placeholder,
                attributes: [NSForegroundColorAttributeName: color, NSFontAttributeName: placeholderFont]
            )
        #endif
    }

    /// A UIFont value that determines the text font of the title label
    @objc dynamic open var titleFont: UIFont = AppFonts.calibri14 {
        didSet {
            updateTitleLabel()
        }
    }
    ...
    */
    ...
    fileprivate func updateTextColor() {
        if !isEnabled {
            ...
            super.textColor = editingOrSelected ? cachedTextColor : titleColor
        }
    }
    ...
    fileprivate var _titleVisible: Bool = true
    ...
    */
    ...
    open func lineViewRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
        let height = editing ? lineHeight : lineHeight
