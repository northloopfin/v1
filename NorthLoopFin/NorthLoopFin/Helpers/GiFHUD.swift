...
public class GIFHUD: UIView {
  ...
  public var gifSpeed: CGFloat = 1.0
  ...
  private init() {
    ...
    clipsToBounds = false
    layer.backgroundColor = UIColor.init(white: 0.9, alpha: 0.8).cgColor//UIColor(white: 0, alpha: 0.5).cgColor
    layer.cornerRadius = 10
    layer.masksToBounds = true

    //imageView = GIFHUDImageView(frame: bounds.insetBy(dx: 20, dy: 20))
    imageView  = GIFHUDImageView.init(frame: CGRect.init(x: 0, y: 0, width: hudSize.width, height: hudSize.height))
