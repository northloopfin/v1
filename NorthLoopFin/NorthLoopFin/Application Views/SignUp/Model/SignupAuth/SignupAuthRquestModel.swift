...
class SignupAuthRquestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->SignupAuthRquestModel{
            return SignupAuthRquestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.SIGNUPAUTH.rawValue
    }
}
