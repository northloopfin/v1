...
class ReferralAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: ReferralRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
    ...
    ServiceManager.sharedInstance.requestPOSTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: Referral.self)
    }
