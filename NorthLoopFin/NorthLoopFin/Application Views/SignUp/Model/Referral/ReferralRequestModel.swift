...
class ReferralRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->ReferralRequestModel{
            return ReferralRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.REFERRAL.rawValue
    }
}
