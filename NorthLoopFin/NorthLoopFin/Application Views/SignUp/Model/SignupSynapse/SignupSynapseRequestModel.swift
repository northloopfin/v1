//
//  SignupSynapseRequestModel.swift
//  NorthLoopFin
//
...
class SignupSynapseRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->SignupSynapseRequestModel{
            return SignupSynapseRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.SIGNUPSYNAPSE.rawValue
    }
}
