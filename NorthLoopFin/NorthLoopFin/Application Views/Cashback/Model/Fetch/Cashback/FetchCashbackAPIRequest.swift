...
class FetchCashbackAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: FetchCashbackRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
        ...
        ServiceManager.sharedInstance.requestGETWithURL(self.apiRequestUrl, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: FetchCashback.self)
    }
