//
//  FetchCashbackRequestModel.swift
//  NorthLoopFin
//
...
class FetchCashbackRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->FetchCashbackRequestModel{
            return FetchCashbackRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.CASHBACK.rawValue
    }
}
