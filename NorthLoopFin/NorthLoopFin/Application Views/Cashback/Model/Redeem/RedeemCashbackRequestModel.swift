//
//  RedeemCashbackRequestModel.swift
//  NorthLoopFin
//
...
class RedeemCashbackRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->RedeemCashbackRequestModel{
            return RedeemCashbackRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.CASHBACKREDEEM.rawValue
    }
}
