...
class CampusVoteRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->CampusVoteRequestModel{
            return CampusVoteRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.CAMPUSVOTE.rawValue
    }
}
