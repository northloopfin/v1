//
//  CampusVoteStatusRequestModel.swift
//  NorthLoopFin
//
...
class CampusVoteStatusRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->CampusVoteStatusRequestModel{
            return CampusVoteStatusRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.CAMPUSSTATUS.rawValue
    }
}
