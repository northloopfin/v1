...
class ATMFinderRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->ATMFinderRequestModel{
            return ATMFinderRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.ATMFINDER.rawValue
    }
}
