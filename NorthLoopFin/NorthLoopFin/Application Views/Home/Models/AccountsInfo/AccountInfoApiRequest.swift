...
class AccountInfoApiRequest:ApiRequestProtocol {
    ...
    func makeAPIRequest(withReqFormData reqFromData: AccountInfoRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback){
        ...
        ServiceManager.sharedInstance.requestGETWithURL(self.apiRequestUrl, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: Account.self)
    }
