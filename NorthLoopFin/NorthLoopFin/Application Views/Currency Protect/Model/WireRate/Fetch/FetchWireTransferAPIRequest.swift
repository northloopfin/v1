//
//  FetchWireTransferAPIRequest.swift
//  NorthLoopFin
//
...
class FetchWireTransferAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: FetchWireTransferRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
        ...
        ServiceManager.sharedInstance.requestGETWithURL(reqFromData.apiUrl, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: WireTransfer.self)
    }
