//
//  FetchWireTransferRequestModel.swift
//  NorthLoopFin
//
...
class FetchWireTransferRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->FetchWireTransferRequestModel{
            return FetchWireTransferRequestModel(builderObject: self)
        }
    }
     ...
     */
    func getEndPoint(transactionID:String)->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.WIRE.rawValue + transactionID
    }
}
