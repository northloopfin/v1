...
class ClaimRefundRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->ClaimRefundRequestModel{
            return ClaimRefundRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint(transactionID:String)->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.CLAIMREFUND.rawValue + transactionID
    }
}
