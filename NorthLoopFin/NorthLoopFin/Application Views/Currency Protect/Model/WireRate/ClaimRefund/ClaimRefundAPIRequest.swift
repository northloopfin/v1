...
class ClaimRefundAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: ClaimRefundRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
        ...
        ServiceManager.sharedInstance.requestPOSTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: ClaimRefund.self)
    }
