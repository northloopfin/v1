//
//  FetchWireListRequestModel.swift
//  NorthLoopFin
//
...
class FetchWireListRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->FetchWireListRequestModel{
            return FetchWireListRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.WIRELIST.rawValue
    }
}
