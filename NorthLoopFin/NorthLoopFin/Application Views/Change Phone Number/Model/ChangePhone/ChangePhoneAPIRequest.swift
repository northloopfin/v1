...
class ChangePhoneAPIRequest:ApiRequestProtocol {
    ...
    func makeAPIRequest(withReqFormData reqFromData: ChangePhoneRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback){
        ...
        ServiceManager.sharedInstance.requestPUTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: ChangePhoneResponse.self)
    }
