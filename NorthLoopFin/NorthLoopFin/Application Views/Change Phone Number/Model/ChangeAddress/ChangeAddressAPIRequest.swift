...
class ChangeAddressAPIRequest:ApiRequestProtocol {
    ...
    func makeAPIRequest(withReqFormData reqFromData: ChangeAddressRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback){
        ...
        ServiceManager.sharedInstance.requestPUTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: ChangeAddressResponse.self)
    }
