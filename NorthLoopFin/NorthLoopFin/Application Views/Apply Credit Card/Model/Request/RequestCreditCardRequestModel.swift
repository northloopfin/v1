//
//  RequestCreditCardRequestModel.swift
//  NorthLoopFin
//
...
class RequestCreditCardRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->RequestCreditCardRequestModel{
            return RequestCreditCardRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.CREDITCARD.rawValue
    }
}
