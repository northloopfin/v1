//
//  RequestCreditCardAPIRequest.swift
//  NorthLoopFin
//
...
class RequestCreditCardAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: RequestCreditCardRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
        ...
        ServiceManager.sharedInstance.requestPOSTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: RequestCreditCard.self)
    }
