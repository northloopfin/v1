//
//  FetchCreditCardRequestModel.swift
//  NorthLoopFin
//
...
class FetchCreditCardRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->FetchCreditCardRequestModel{
            return FetchCreditCardRequestModel(builderObject: self)
        }
    }
