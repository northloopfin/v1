//
//  FetchCreditCardAPIRequest.swift
//  NorthLoopFin
//
...
class FetchCreditCardAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: FetchCreditCardRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
        ...
        ServiceManager.sharedInstance.requestGETWithURL(self.apiRequestUrl, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: FetchCreditCard.self)
    }
