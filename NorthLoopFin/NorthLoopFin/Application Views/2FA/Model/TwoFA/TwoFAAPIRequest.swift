...
class TwoFAAPIRequest:ApiRequestProtocol {
    ...
    func makeAPIRequest(withReqFormData reqFromData: TwoFARequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback){
