...
import Foundation
class LinkACHAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: LinkACHRquestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
    ...
    ServiceManager.sharedInstance.requestPOSTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: LinkACH.self)
    }
