//
//  ACHTransactionAPIRequest.swift
//  NorthLoopFin
//
...
class ACHTransactionAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: ACHTransactionRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
