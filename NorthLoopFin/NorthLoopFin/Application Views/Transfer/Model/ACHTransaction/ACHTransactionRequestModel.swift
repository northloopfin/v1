//
//  ACHTransactionRequestModel.swift
//  NorthLoopFin
//
...
class ACHTransactionRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->ACHTransactionRequestModel{
            return ACHTransactionRequestModel(builderObject: self)
        }
    }
