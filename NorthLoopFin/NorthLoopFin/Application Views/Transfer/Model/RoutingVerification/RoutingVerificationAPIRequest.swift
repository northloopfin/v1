//
//  RoutingVerificationAPIRequest.swift
//  NorthLoopFin
//
...
class RoutingVerificationAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: RoutingVerificationRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
    ...
    ServiceManager.sharedInstance.requestPOSTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: RoutingVerification.self)
    }
