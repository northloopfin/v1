...
class DeleteACHRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->DeleteACHRequestModel{
            return DeleteACHRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.LINKACH.rawValue
    }
}
