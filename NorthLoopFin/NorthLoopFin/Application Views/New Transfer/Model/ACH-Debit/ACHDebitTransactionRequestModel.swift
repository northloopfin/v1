//
//  ACHDebitTransactionRequestModel.swift
//  NorthLoopFin
//
...
class ACHDebitTransactionRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->ACHDebitTransactionRequestModel{
            return ACHDebitTransactionRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.ACHDEBIT.rawValue
    }
}
