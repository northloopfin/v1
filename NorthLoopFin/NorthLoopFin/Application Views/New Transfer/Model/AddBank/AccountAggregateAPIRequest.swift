//
//  AccountAggregateAPIRequest.swift
//  NorthLoopFin
//
...
class AccountAggregateAPIRequest:ApiRequestProtocol {
     ...
     */
    func makeAPIRequest(withReqFormData reqFromData: AccountAggregateRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback) {
...
//        print(self.apiRequestUrl)
    ...
    ServiceManager.sharedInstance.requestPOSTWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: AccountAggregate.self)
    }
