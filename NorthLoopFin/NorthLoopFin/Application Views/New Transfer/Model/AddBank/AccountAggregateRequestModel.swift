//
//  AccountAggregateRequestModel.swift
//  NorthLoopFin
//
...
class AccountAggregateRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->AccountAggregateRequestModel{
            return AccountAggregateRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.ACCOUNTAGGREGATE.rawValue
    }
}
