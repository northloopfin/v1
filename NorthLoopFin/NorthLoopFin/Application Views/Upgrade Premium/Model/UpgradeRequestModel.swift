...
class UpgradeRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->UpgradeRequestModel{
            return UpgradeRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.UPGRADEPREMIUM.rawValue
    }
}
