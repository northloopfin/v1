...
class AccountAPIRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->AccountAPIRequestModel{
            return AccountAPIRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.USERTRANSFERDETAIL.rawValue
    }
}
