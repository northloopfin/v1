...
class CardInfoAPIRequest {
    ...
    func makeAPIRequest(withReqFormData reqFromData: CardInfoRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback){
        ...
        ServiceManager.sharedInstance.requestGETWithURL(self.apiRequestUrl, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: CardInfo.self)
    }
