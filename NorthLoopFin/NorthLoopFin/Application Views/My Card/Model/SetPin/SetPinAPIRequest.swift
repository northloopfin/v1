...
class SetPinAPIRequest:ApiRequestProtocol {
    ...
    func makeAPIRequest(withReqFormData reqFromData: SetPinRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback){
    ...
    //ServiceManager.sharedInstance.requestGETWithURL(self.apiRequestUrl, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: SetPinResponse.self)
        ServiceManager.sharedInstance.requestPATCHWithURL(self.apiRequestUrl, andRequestDictionary: reqFromData.requestQueryParams, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: SetPinResponse.self)
    }
