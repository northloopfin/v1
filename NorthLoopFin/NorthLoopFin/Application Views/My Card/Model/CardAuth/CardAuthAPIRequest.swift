...
class CardAuthAPIRequest {
    ...
    func makeAPIRequest(withReqFormData reqFromData: CardAuthRequestModel, errorResolver: ErrorResolver, responseCallback: ResponseCallback){
        ...
        ServiceManager.sharedInstance.requestGETWithURL(self.apiRequestUrl, requestHeader: reqFromData.requestHeader, responseCallBack: responseWrapper, returningClass: CardAuthData.self)
    }
