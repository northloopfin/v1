...
class CardAuthRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->CardAuthRequestModel{
            return CardAuthRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.CARDSTATUS.rawValue + "/oauth"
    }
