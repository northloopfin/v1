...
class ZendeskRequestModel {
    ...
    internal class Builder{
         ...
         */
        func build()->ZendeskRequestModel{
            return ZendeskRequestModel(builderObject: self)
        }
    }
    ...
    func getEndPoint()->String{
        return Endpoints.Base_Url!  +  Endpoints.APIEndpoints.ZENDESK.rawValue
    }
}
